  ...
  describe('transfer from', function () {
    ...
    describe('when the token owner is not the zero address', function () {
      ...
      describe('when the recipient is not the zero address', function () {
          ...
          describe('when the token owner does not have enough balance', function () {
            ...
            it('reverts', async function () {
              await expectRevert(this.token.transferFrom(
                tokenOwner, to, amount, { from: spender }), `${errorPrefix}: Insufficient Balance`,
              );
            });
          });
        });
        ...
        describe('when the spender does not have enough approved balance', function () {
          ...
          describe('when the token owner has enough balance', function () {
            ...
            it('reverts', async function () {
              await expectRevert(this.token.transferFrom(
                tokenOwner, to, amount, { from: spender }), `${errorPrefix}: Check for approved token count failed`,
              );
            });
          });
      ...
      describe('when the recipient is the zero address', function () {
        ...
        it('reverts', async function () {
          await expectRevert(this.token.transferFrom(
            tokenOwner, to, amount, { from: spender }), `${errorPrefix}: Cannot have recipient as zero address`,
          );
        });
      });
    });
    ...
    describe('when the token owner is the zero address', function () {
      ...
      it('reverts', async function () {
        await expectRevert(this.token.transferFrom(
          tokenOwner, to, amount, { from: spender }), `${errorPrefix}: Cannot have sender as zero address`,
        );
      });
    });
  });
    ...
    describe('when the sender does not have enough balance', function () {
      ...
      it('reverts', async function () {
        await expectRevert(transfer.call(this, from, to, amount),
          `${errorPrefix}: Insufficient Balance`,
        );
      });
    });
  ...
  describe('when the recipient is the zero address', function () {
    it('reverts', async function () {
      await expectRevert(transfer.call(this, from, ZERO_ADDRESS, balance),
        `${errorPrefix}: Cannot have recipient as zero address`,
      );
    });
  });
}
